...
namespace LinqToRdf.Designer
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides LinqToRdfDesigner files
	/// The implementation is done in LinqToRdfDesignerDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class LinqToRdfDesignerDirectiveProcessor : LinqToRdfDesignerDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public LinqToRdfDesignerDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides LinqToRdfDesigner files
	/// </summary>
	public class LinqToRdfDesignerDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string LinqToRdfDesignerDirectiveProcessorName = "LinqToRdfDesignerDirectiveProcessor";
		...
		/// </summary>
		private const string supportedDirectiveName = "LinqToRdfDesigner";
		...
		/// Constructor
		/// </summary>
		public LinqToRdfDesignerDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return LinqToRdfDesignerDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::LinqToRdf.Designer.ModelRoot));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::LinqToRdf.Designer.ModelRoot));
			...
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					string[] domainModels = {
						...
						"LinqToRdf.Designer.LinqToRdfDesignerDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("LinqToRdfDesignerDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("LinqToRdf.Designer");
