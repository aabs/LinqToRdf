...
namespace LinqToRdf.Designer
{
	...
	/// </remarks>
	public partial class LinqToRdfDesignerToolboxHelper : LinqToRdfDesignerToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new LinqToRdfDesignerToolboxHelper.
		/// </summary>
		public LinqToRdfDesignerToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	/// Helper class used to create and initialize toolbox items for this DSL.
	/// </summary>
	public abstract class LinqToRdfDesignerToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify LinqToRdfDesigner toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "LinqToRdfDesigner.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new LinqToRdfDesignerToolboxHelperBase.
		/// </summary>
		protected LinqToRdfDesignerToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::LinqToRdf.Designer.LinqToRdfDesignerDomainModel.SingletonResourceManager.GetString("Class DiagramsToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual global::System.Collections.Generic.IList<DslDesign::ModelingToolboxItem> CreateToolboxItems()
		{
			...
			using(DslModeling::Store store = new DslModeling::Store(this.ServiceProvider))
			{
				store.LoadDomainModels(typeof(DslDiagrams::CoreDesignSurfaceDomainModel),
					typeof(global::LinqToRdf.Designer.LinqToRdfDesignerDomainModel));
				...
				using(DslModeling::Transaction t = store.TransactionManager.BeginTransaction("CreateToolboxItems"))
				{
					...
					toolboxItems.Add(new DslDesign::ModelingToolboxItem(
						...
						CreateElementToolPrototype(store, global::LinqToRdf.Designer.ModelClass.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
					...
					toolboxItems.Add(new DslDesign::ModelingToolboxItem(
						...
						CreateElementToolPrototype(store, global::LinqToRdf.Designer.ModelAttribute.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						}));
					...
					toolboxItems.Add(new DslDesign::ModelingToolboxItem(
						...
						CreateElementToolPrototype(store, global::LinqToRdf.Designer.ClassOperation.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						}));
					...
					toolboxItems.Add(new DslDesign::ModelingToolboxItem(
						...
						CreateElementToolPrototype(store, global::LinqToRdf.Designer.ModelInterface.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						}));
					...
					toolboxItems.Add(new DslDesign::ModelingToolboxItem(
						...
						CreateElementToolPrototype(store, global::LinqToRdf.Designer.InterfaceOperation.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						}));
					...
					toolboxItems.Add(new DslDesign::ModelingToolboxItem(
						...
						CreateElementToolPrototype(store, global::LinqToRdf.Designer.MultipleAssociation.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						}));
					...
					toolboxItems.Add(new DslDesign::ModelingToolboxItem(
						...
						CreateElementToolPrototype(store, global::LinqToRdf.Designer.Comment.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						}));
