...
namespace LinqToRdf.Design
{
	...
	/// </remarks>
	public partial class LinqToRdfDesignerHelpKeywordHelper : LinqToRdfDesignerHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new LinqToRdfDesignerHelpKeywordHelper.
		/// </summary>
		protected LinqToRdfDesignerHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the LinqToRdfDesignerHelpKeywordHelper.
		/// </summary>
		public static LinqToRdfDesignerHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class LinqToRdfDesignerHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new LinqToRdfDesignerHelpKeywordHelperBase.
		/// </summary>
		protected LinqToRdfDesignerHelpKeywordHelperBase()
			: base() { }
