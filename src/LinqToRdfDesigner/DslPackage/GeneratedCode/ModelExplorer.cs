...
namespace LinqToRdf.Designer.DslPackage
{
	...
	/// </summary>
	internal partial class LinqToRdfDesignerExplorer : LinqToRdfDesignerExplorerBase
	{
		/// <summary>
		/// Constructs a new LinqToRdfDesignerExplorer.
		/// </summary>
		public LinqToRdfDesignerExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the LinqToRdfDesignerExplorerToolWindow.
	/// </summary>
	internal abstract class LinqToRdfDesignerExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new LinqToRdfDesignerExplorerBase.
		/// </summary>
		protected LinqToRdfDesignerExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.LinqToRdfDesignerExplorerMenu;
			}
		}
		...
		{
			get { return global::LinqToRdf.Designer.ModelRoot.DomainClassId; }
		}
