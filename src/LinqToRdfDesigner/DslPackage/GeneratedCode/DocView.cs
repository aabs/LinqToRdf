...
namespace LinqToRdf.Designer.DslPackage
{
	...
	/// </summary>
	internal partial class LinqToRdfDesignerDocView : LinqToRdfDesignerDocViewBase
	{
		/// <summary>
		/// Constructs a new LinqToRdfDesignerDocView.
		/// </summary>
		public LinqToRdfDesignerDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class LinqToRdfDesignerDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new LinqToRdfDesignerDocView.
		/// </summary>
		protected LinqToRdfDesignerDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			global::System.Collections.ObjectModel.ReadOnlyCollection<global::LinqToRdf.Designer.ClassDiagram> diagrams = this.DocData.Store.ElementDirectory.FindElements<global::LinqToRdf.Designer.ClassDiagram>();
			if (diagrams.Count > 0)
			{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::LinqToRdf.Designer.LinqToRdfDesignerToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::LinqToRdf.Designer.LinqToRdfDesignerToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.LinqToRdfDesignerDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::LinqToRdf.Designer.LinqToRdfDesignerHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::LinqToRdf.Designer.LinqToRdfDesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::LinqToRdf.Designer.LinqToRdfDesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
