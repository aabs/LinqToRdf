...
namespace LinqToRdf.Design.DslPackage
{
	...
	internal abstract class LinqToRdfDesignerDocViewBase : DslShell::SingleDiagramDocView
	{
		...
		protected override bool LoadView()
		{
			...
			global::System.Collections.ObjectModel.ReadOnlyCollection<global::LinqToRdf.Design.ClassDiagram> diagrams = this.DocData.Store.ElementDirectory.FindElements<global::LinqToRdf.Design.ClassDiagram>();
			if (diagrams.Count > 0)
			{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::LinqToRdf.Design.LinqToRdfDesignerToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::LinqToRdf.Design.LinqToRdfDesignerToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::LinqToRdf.Design.LinqToRdfDesignerHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::LinqToRdf.Design.LinqToRdfDesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::LinqToRdf.Design.LinqToRdfDesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
