...
namespace LinqToRdf.Designer.DslPackage
{
	...
	internal abstract class LinqToRdfDesignerDocDataBase : DslShell::ModelingDocData
	{
		...
		protected override string FormatList
		{
			get
			{
                return global::LinqToRdf.Designer.LinqToRdfDesignerDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::LinqToRdf.Designer.ModelRoot modelRoot = null;
			...
			global::LinqToRdf.Designer.LinqToRdfDesignerDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::LinqToRdf.Designer.LinqToRdfDesignerSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.Store, fileName, diagramFileName, schemaResolver, null /* no load-time validation */);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::LinqToRdf.Designer.LinqToRdfDesignerDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::LinqToRdf.Designer.LinqToRdfDesignerDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::LinqToRdf.Designer.ModelRoot modelRoot = this.RootElement as global::LinqToRdf.Designer.ModelRoot;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::LinqToRdf.Designer.ClassDiagram diagram = diagrams[0] as global::LinqToRdf.Designer.ClassDiagram;
					if (diagram != null)
					{
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::LinqToRdf.Designer.ModelRoot modelRoot = (global::LinqToRdf.Designer.ModelRoot)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::LinqToRdf.Designer.LinqToRdfDesignerSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::LinqToRdf.Designer.LinqToRdfDesignerSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::LinqToRdf.Designer.LinqToRdfDesignerDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::LinqToRdf.Designer.LinqToRdfDesignerSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::LinqToRdf.Designer.LinqToRdfDesignerSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
