...
{
    /// <summary>
    /// a list of typical primitive datatypes defined in the XMLSchema datatypes (xsdt) specification.
    /// </summary>
    ...
    public class XsdtTypeConverter : ITypeTranslator
    {
        ...
        public object Get(Type t, object obj)
        {
            ...
            if (dt != XsdtPrimitiveDataType.XsdtInt && dt != XsdtPrimitiveDataType.XsdtString)
                xsdTypeSuffix = "^^xsdt:" + attr.TypeUri;
            else
                xsdTypeSuffix = "";
        ...
        internal void Parse(XsdtType x)
        {
