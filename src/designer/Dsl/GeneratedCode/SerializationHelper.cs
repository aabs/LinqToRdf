...
namespace LinqToRdf.Design
{
	...
	public partial class ModelRootSerializer
	{
				...
				if (schemaResolver != null)
				{
					...
					if (!string.IsNullOrEmpty(targetNamespace))
					{
						...
						if (schemas != null && schemas.Count > 0)
						{
							if (schemas.Count > 1)
							{
								LinqToRdfSerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
							}
							...
							LinqToRdfSerializationBehaviorSchemaValidationCallback validationCallback = new LinqToRdfSerializationBehaviorSchemaValidationCallback(serializationContext);
						...
						{
							LinqToRdfSerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
						}
					}
				}
		...
		private static void CheckVersion(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader)
		{
			...
			if (dslVersionStr != null)
			{
				try
				{
					...
					{
						LinqToRdfSerializationBehaviorSerializationMessages.VersionMismatch(serializationContext, reader, expectedVersion, actualVersion);
					}
				}
				catch (global::System.ArgumentException)
				{
					LinqToRdfSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "dslVersion", typeof(global::System.Version), dslVersionStr);
				}
		...
		/// </summary>
		private sealed class LinqToRdfSerializationBehaviorSchemaValidationCallback
		{
			...
			internal LinqToRdfSerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					LinqToRdfSerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
		...
		public override void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer)
		{
			...
			rootElementSettings.SchemaTargetNamespace = "http://schemas.microsoft.com/dsltools/LinqToRdf";
...
{
	/// <summary>
	/// Helper class for serializing and deserializing LinqToRdf models.
	/// </summary>
	public abstract partial class LinqToRdfSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected LinqToRdfSerializationHelperBase() { }
		#endregion
		...
		public virtual ModelRoot LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			...
			{
				throw new global::System.InvalidOperationException(LinqToRdfDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
			}
			...
			if (modelRootSerializer != null)
			{
				using (global::System.IO.FileStream fileStream = global::System.IO.File.OpenRead(fileName))
				{
					using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + fileName, true))
					{
						...
						// Set up MonikerResolver for LinqToRdf.
		...
		public virtual string GetSerializedModelString(global::LinqToRdf.Design.ModelRoot modelRoot, global::System.Text.Encoding encoding)
		{
		...
		/// <summary>
		/// DomainXmlSerializerDirectory instance used by this LinqToRdfSerializationHelper class.
		/// </summary>
		...
		protected virtual DslModeling::DomainXmlSerializerDirectory Directory
		{
			...
			get
			{
				if (this.directory == null)
				{
					...
					directory.AddBehavior(LinqToRdfSerializationBehavior.Instance);
				}
		...
		internal protected virtual global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> GetMonikerResolvers(DslModeling::Store store)
		{
			...
			result.Add(LinqToRdfDomainModel.DomainModelId, new LinqToRdfSerializationBehaviorMonikerResolver(store, this.Directory));
			return result;
		}
	...
	/// Helper class for serializing and deserializing LinqToRdf models.
	/// </summary>
	public sealed partial class LinqToRdfSerializationHelper : LinqToRdfSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private LinqToRdfSerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static LinqToRdfSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static LinqToRdfSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (LinqToRdfSerializationHelper.instance == null)
					LinqToRdfSerializationHelper.instance = new LinqToRdfSerializationHelper();
				return LinqToRdfSerializationHelper.instance;
			}
		}
		#endregion
	}
...
namespace LinqToRdf.Design
{
	...
	public partial class ModelRoot
	{
		...
		{
			global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> monikerResolvers = LinqToRdfSerializationHelper.Instance.GetMonikerResolvers(this.Store);
						...
						{	// Ambiguous moniker detected.
							context.LogError(
								string.Format(
									...
									LinqToRdfDomainModel.SingletonResourceManager.GetString("AmbiguousMoniker"),
									amEx.Moniker,
