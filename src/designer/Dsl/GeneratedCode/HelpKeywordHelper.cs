...
namespace LinqToRdf.Design
{
	...
	/// </remarks>
	public partial class LinqToRdfHelpKeywordHelper : LinqToRdfHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new LinqToRdfHelpKeywordHelper.
		/// </summary>
		protected LinqToRdfHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the LinqToRdfHelpKeywordHelper.
		/// </summary>
		public static LinqToRdfHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class LinqToRdfHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new LinqToRdfHelpKeywordHelperBase.
		/// </summary>
		protected LinqToRdfHelpKeywordHelperBase()
			: base() { }
