...
namespace LinqToRdf.Design.DslPackage
{
	...
	/// </summary>
	internal partial class LinqToRdfDocView : LinqToRdfDocViewBase
	{
		/// <summary>
		/// Constructs a new LinqToRdfDocView.
		/// </summary>
		public LinqToRdfDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class LinqToRdfDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new LinqToRdfDocView.
		/// </summary>
		protected LinqToRdfDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::LinqToRdf.Design.LinqToRdfToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::LinqToRdf.Design.LinqToRdfToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.LinqToRdfDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::LinqToRdf.Design.LinqToRdfHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::LinqToRdf.Design.LinqToRdfHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::LinqToRdf.Design.LinqToRdfHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
