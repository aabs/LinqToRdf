...
namespace LinqToRdf.Design.DslPackage
{
	...
	/// </summary>
	internal partial class LinqToRdfDocData : LinqToRdfDocDataBase
	{
		/// <summary>
		/// Constructs a new LinqToRdfDocData.
		/// </summary>
		public LinqToRdfDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a LinqToRdf document in memory.
	/// </summary>
	internal abstract class LinqToRdfDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new LinqToRdfDocDataBase.
		/// </summary>
		protected LinqToRdfDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
                return global::LinqToRdf.Design.LinqToRdfDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::LinqToRdf.Design.LinqToRdfSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
