...
namespace LinqToRdf.Design.DslPackage
{
	...
	[VSShell::ProvideToolWindow(typeof(LinqToRdfExplorerToolWindow), MultiInstances = false, Style = VSShell::VsDockStyle.Tabbed, Orientation = VSShell::ToolWindowOrientation.Right, Window = "{3AE79031-E1BC-11D0-8F78-00A0C9110057}")]
	[VSShell::ProvideToolWindowVisibility(typeof(LinqToRdfExplorerToolWindow), Constants.LinqToRdfEditorFactoryId)]
	[VSShell::ProvideEditorFactory(typeof(LinqToRdfEditorFactory), 103, TrustLevel = VSShellInterop::__VSEDITORTRUSTLEVEL.ETL_AlwaysTrusted)]
	[VSShell::ProvideEditorExtension(typeof(LinqToRdfEditorFactory), "." + Constants.DesignerFileExtension, 32)]
	...
	internal abstract partial class LinqToRdfPackageBase : DslShell::ModelingPackage
	{
		/// <summary>
		...
		protected override void Initialize()
		{
			...
			this.RegisterEditorFactory(new LinqToRdfEditorFactory(this));

			// Create the command set that handles menu commands provided by this package.
			LinqToRdfCommandSet commandSet = new LinqToRdfCommandSet(this);
			commandSet.Initialize();
			
			// Register the model explorer tool window for this DSL.
			this.AddToolWindow(typeof(LinqToRdfExplorerToolWindow));
		...
		{
			global::LinqToRdf.Design.LinqToRdfToolboxHelper toolboxHelper = new global::LinqToRdf.Design.LinqToRdfToolboxHelper(this);
			try
			{
...
namespace LinqToRdf.Design.DslPackage
{
	...
	[VSTextTemplatingHost::ProvideDirectiveProcessor(typeof(global::LinqToRdf.Design.LinqToRdfDirectiveProcessor), global::LinqToRdf.Design.LinqToRdfDirectiveProcessor.LinqToRdfDirectiveProcessorName, "A directive processor that provides access to LinqToRdf files")]
	[global::System.Runtime.InteropServices.Guid(Constants.LinqToRdfPackageId)]
	internal sealed partial class LinqToRdfPackage : LinqToRdfPackageBase
	{
	}
}