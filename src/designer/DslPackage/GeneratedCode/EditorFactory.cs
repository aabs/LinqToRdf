...
namespace LinqToRdf.Design.DslPackage
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.LinqToRdfEditorFactoryId)]
	internal partial class LinqToRdfEditorFactory : LinqToRdfEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new LinqToRdfEditorFactory.
		/// </summary>
		public LinqToRdfEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class LinqToRdfEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected LinqToRdfEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new LinqToRdfDocData(this.ServiceProvider, typeof(LinqToRdfEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new LinqToRdfDocView(docData, this.ServiceProvider);
		}
	}
}
