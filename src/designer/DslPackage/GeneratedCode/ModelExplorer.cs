...
namespace LinqToRdf.Design.DslPackage
{
	...
	/// </summary>
	internal partial class LinqToRdfExplorer : LinqToRdfExplorerBase
	{
		/// <summary>
		/// Constructs a new LinqToRdfExplorer.
		/// </summary>
		public LinqToRdfExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the LinqToRdfExplorerToolWindow.
	/// </summary>
	internal abstract class LinqToRdfExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new LinqToRdfExplorerBase.
		/// </summary>
		protected LinqToRdfExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.LinqToRdfExplorerMenu;
			}
		}
